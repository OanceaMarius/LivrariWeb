...
@Configuration
@EnableJpaRepositories(basePackages = "ro.papetti.livrari.repozitoriesLiv", 
...
public class DatabaseLivrariConfig {
    ...
    public LocalContainerEntityManagerFactoryBean livrariEntityManagerFactory(@Qualifier("livrariDataSource") DataSource dataSource){
        ...
        em.setPackagesToScan("ro.papetti.LivrariTabele.entity"); // pachetul unde sunt entitățile de livrari  em.setPackagesToScan(new String[] { "com.example.entity.primary" });
...
//        properties.put("jdbcUrl", "jdbc:sqlserver://Srvrsbs02:1433;databaseName=Papetti_livrari;encrypt=false;integratedSecurity=false");
